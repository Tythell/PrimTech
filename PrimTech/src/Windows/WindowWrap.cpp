...
#include<omp.h>
	...
	LRESULT CALLBACK MessageDirect(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
	{
		...
		default:
		{
			PrimtTech::Window* const pWindow = reinterpret_cast<PrimtTech::Window*>(GetWindowLongPtr(hwnd, GWLP_USERDATA));
	...
	LRESULT CALLBACK HandleMessageSetup(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
	{
		...
		case WM_NCCREATE:
		{
			...
			PrimtTech::Window* pWindow = reinterpret_cast<PrimtTech::Window*>(pCreate->lpCreateParams);
			if (pWindow == nullptr)
			{
